...
<head>
  ...
  <style>
    ...
    @media(max-width:980px){.category-grid{grid-template-columns:repeat(2,1fr)}.product-card{grid-template-columns:70px 1fr}.product-visual{grid-column:2}.product-body{grid-column:1/-1}}
    @media(max-width:600px){.product-controls .search-row{display:block}.product-controls input{max-width:none;margin-top:10px}.category-grid,.product-body dl{grid-template-columns:1fr}.product-card{display:block}.product-rank{margin-bottom:10px}.product-visual{margin-bottom:14px}}
  </style>
</head>
