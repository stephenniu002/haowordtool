...
<body class="top-products-page">
  ...
  <main id="main">
    ...
    <section class="offer-section" aria-labelledby="affiliate-offers-title">
      ...
      <p class="tracking-note"><strong>Affiliate disclosure:</strong> HaoWordTool may earn a commission from qualifying purchases after official tracking links are activated, at no extra cost to the buyer. The current buttons are ordinary destination links while Fiverr Deep Links and an approved Amazon Associates tag are being configured. Product availability, prices and seller terms can change.</p>
    </section>
