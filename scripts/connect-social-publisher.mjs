...
for (const file of ['index.html', 'en/index.html', 'pricing.html', 'templates.html']) {
  ...
  }
  {
    ...
    const card = english
      ? '<section id="social-publisher-offer" class="lesson-download" style="margin:32px 0"><p class="eyebrow">CREATOR TOOLS</p><h2>Publish across your social channels.</h2><p>Request setup of social-auto-upload for Douyin (China), TikTok (international), Xiaohongshu, Bilibili, YouTube and more. Platform availability is assessed before payment. Service plans: US$25 per month or US$299 per year.</p><a class="button primary" href="/social-publisher.html">Explore Social Publisher →</a></section>'
